  ...
  return (
    <section className="py-16" id="pricing">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="max-w-2xl mx-auto mb-16 rounded-xl border-2 border-primary bg-white relative transition-all duration-300 hover:shadow-xl">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                ...
                <CheckoutButton
                  ...
                  mode="payment"
                  cancelUrl={cancelUrl}
                  className="w-full md:w-auto bg-primary hover:bg-amber-200"
                >
                  {ctaText}
                </CheckoutButton>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col h-full rounded-xl border-2 border-gray-200 transition-all duration-300 hover:border-primary hover:shadow-lg relative">
            <div className="p-6 flex flex-col flex-grow">
              <div className="bg-primary-light text-primary text-xs font-medium px-3 py-1 rounded-full self-start mb-4">
                {subscriptionPlan}
              </div>
