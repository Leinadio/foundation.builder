---
title: Déploiement
description: Guide de déploiement de Foundation Builder
---
  ...
  <div className="h-96 overflow-y-auto bg-white rounded-b-lg">
    <div className="p-4">
      <Hero
        ...
        title="Transformez vos conversations en souvenirs précieux"
        description="Capturez les moments drôles, touchants ou mémorables de vos conversations et affichez-les dans de magnifiques cadres photo personnalisés. Gardez vos échanges les plus précieux pour toujours."
      />
    </div>
  </div>
</div>
...
Ce guide vous accompagne dans le déploiement de Foundation Builder sur différentes plateformes.
